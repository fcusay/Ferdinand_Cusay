...
class MessageDAO {
    ...
    public static function createMessage($message) {
        ...
        $email = $message['email'];
        $query = "INSERT INTO `message`(`name`, `message`, `email`, `date_posted`) VALUES ('$name','$message2','$email',CURRENT_DATE)";
        mysql_query($query); 
    }
    ...
    public static function getMessage() {
        ...
        $query = mysql_query("SELECT * FROM `message` WHERE is_approved = 'Y'");
        return $query;
    ...
    public static function numRows() {
        // 
        $rows = mysql_query("SELECT * FROM `message` WHERE is_approved = 'Y'");
        mysql_num_rows($rows);
    }
    ...
    public static function updateMessage($message) {
        // Execute SQL to update the message
            ...
            mysql_query("UPDATE `message` SET `id`='$id',`name`='$name',`message`='$message2',`email`='$email',`date_posted`=CURRENT_DATE,`is_approved`='$is_approved'");
    }
    ...
    public static function approveMessage($id) {
            mysql_query("UPDATE message SET is_approved='Y' WHERE id='$id'");
    }
    ...
    public static function rejectMessage($id) {
            mysql_query("UPDATE message SET is_approved='N' WHERE id='$id'");
    }
}
